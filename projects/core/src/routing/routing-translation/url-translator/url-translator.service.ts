...
import { ParamsMapping, RouteTranslation } from '../routes-translations/routes-translations';
import { isParam, getParamName } from '../route-recognizer/path-utils';
import { ConfigurableRoutesService } from '../routes-translations/routes-translations.service';
import { RouteRecognizerService } from '../route-recognizer/route-recognizer.service';
  ...
  translate(
    ...
    if (typeof urlOrNestedRoutesNames === 'string') {
      ...
      ({
        nestedRoutesNames,
        nestedRoutesParams
      } = this.routeRecognizer.recognize(url));
